...
const useDebounce = require("./useDebounce-B32iVUKs.cjs");
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const vmodel = vue.useModel(__props, "modelValue", {
      ...
      set: (value) => typeof value == "undefined" ? value : helpers.isTrueish(props.number) ? Number(value) : String(value)
    });
...
//# sourceMappingURL=Input.vue_vue_type_script_setup_true_lang-CcgbUq2q.cjs.map
