...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels({
    ...
    multiple: {},
    variant: { default: () => config.getDefault("upload.variant") },
  ...
  emits: /* @__PURE__ */ vue.mergeModels(["update:model-value", "focus", "blur", "invalid"], ["update:modelValue"]),
  setup(__props, { expose: __expose, emit: __emit }) {
    const props = __props;
    const emits = __emit;
    const inputRef = vue.useTemplateRef("inputElement");
    const { checkHtml5Validity, onFocus, onBlur, onInvalid, isValid, setFocus } = useInputHandler.useInputHandler(inputRef, emits, props);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("label", {
        ...
        !_ctx.dragDrop ? vue.renderSlot(_ctx.$slots, "default", {
          ...
          vue.renderSlot(_ctx.$slots, "default", { onclick: onClick })
        ], 34)),
        vue.createElementVNode("input", vue.mergeProps(inputBind.value, {
          ref: "inputElement",
          type: "file",
