...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels({
    ...
    trapFocus: { type: Boolean, default: () => config.getDefault("timepicker.trapFocus", true) },
...
//# sourceMappingURL=Timepicker.vue_vue_type_script_setup_true_lang-B6iegDD8.cjs.map
