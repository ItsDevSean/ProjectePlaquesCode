...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels({
    ...
    scroll: { default: () => config.getDefault("modal.scroll", "keep") },
    trapFocus: { type: Boolean, default: () => config.getDefault("modal.trapFocus", true) },
    ariaRole: { default: () => config.getDefault("modal.ariaRole", "dialog") },
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const toggleScroll = usePreventScrolling.usePreventScrolling(props.scroll === "keep");
...
const useModalProgrammatic = {
  ...
  open(options, target) {
    ...
    return useProgrammatic.useProgrammatic.open(
      _sfc_main,
      {
        instances,
...
const index = {
  install(app) {
    ...
    plugins.registerComponentProgrammatic(app, "modal", useModalProgrammatic);
  }
};
exports.OModal = _sfc_main;
exports.default = index;
exports.useModalProgrammatic = useModalProgrammatic;
