...
const Button_vue_vue_type_script_setup_true_lang = require("./Button.vue_vue_type_script_setup_true_lang-Diu9uGf6.cjs");
const Select_vue_vue_type_script_setup_true_lang = require("./Select.vue_vue_type_script_setup_true_lang-DPA04RD3.cjs");
const utils = require("./utils-DmvciXxo.cjs");
...
function useDatepickerMixins(props) {
  ...
  const isTypeMonth = vue.computed(() => props.type === "month");
  ...
  function dateFormatter(date) {
    ...
    return !helpers.isTrueish(props.multiple) && !helpers.isTrueish(props.range) ? dates.join(" - ") : dates.join(", ");
  }
  function dateParser(date) {
    if (typeof props.parser === "function") return props.parser(date);
    if (!date) return void 0;
    const isArray = helpers.isTrueish(props.multiple) || helpers.isTrueish(props.range);
    ...
    const dates = targetDates.map((date2) => {
      if (dtf.value.formatToParts && typeof dtf.value.formatToParts === "function") {
        ...
        const dateGroups = utils.matchWithGroups(formatRegex, date2);
...
const _hoisted_2$1 = ["tabindex", "onClick", "onMouseenter", "onFocus", "onKeydown"];
const _sfc_main$3 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const hasEvents = vue.computed(() => {
      var _a;
      return !!((_a = props.events) == null ? void 0 : _a.length);
    });
    const dayRefs = vue.ref(/* @__PURE__ */ new Map());
    ...
    function getWeekNumber(mom) {
      ...
      const weekOffset = utils.firstWeekOffset(mom.getFullYear(), dow, doy);
      const week = Math.floor((getDayOfYear(mom) - weekOffset - 1) / 7) + 1;
      let resWeek;
      let resYear;
      if (week < 1) {
        resYear = mom.getFullYear() - 1;
        resWeek = week + utils.weeksInYear(resYear, dow, doy);
      } else if (week > utils.weeksInYear(mom.getFullYear(), dow, doy)) {
        resWeek = week - utils.weeksInYear(mom.getFullYear(), dow, doy);
        resYear = mom.getFullYear() + 1;
      } else {
    ...
    function setRangeHoverEndDate(day) {
      if (helpers.isTrueish(props.pickerProps.range)) emits("hover-enddate", day);
    }
      ...
      const classes = defineClasses.defineClasses(
        [
          ...
          dateMatch(day, props.selectedDate) || dateWithin(
            day,
            props.selectedDate,
            helpers.isTrueish(props.pickerProps.multiple)
          )
        ],
        [
    ...
    const tableRowClasses = defineClasses.defineClasses(["tableRowClass", "o-dpck__table__row"]);
    const tableCellClasses = defineClasses.defineClasses([
      "tableCellClass",
      "o-dpck__table__cell"
    ]);
    const tableEventsClasses = defineClasses.defineClasses([
      "tableEventsClass",
      "o-dpck__table__events"
    ]);
    const cellEventsClass = defineClasses.defineClasses([
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(vue.unref(tableRowClasses))
      }, [
        __props.pickerProps.showWeekNumber ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: vue.normalizeClass(vue.unref(tableCellClasses)),
          style: vue.normalizeStyle({
            cursor: __props.pickerProps.weekNumberClickable ? "pointer" : "auto"
          }),
          tabindex: __props.pickerProps.weekNumberClickable ? 0 : void 0,
          role: "button",
          onClick: _cache[0] || (_cache[0] = vue.withModifiers(($event) => clickWeekNumber(getWeekNumber(__props.week[6])), ["prevent"])),
          onKeydown: _cache[1] || (_cache[1] = vue.withKeys(vue.withModifiers(($event) => clickWeekNumber(getWeekNumber(__props.week[6])), ["prevent"]), ["enter"]))
        }, [
          vue.createElementVNode("span", null, vue.toDisplayString(getWeekNumber(__props.week[6])), 1)
        ], 46, _hoisted_1$1)) : vue.createCommentVNode("", true),
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.week, (weekDay, idx) => {
          return vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: idx }, [
            !__props.pickerProps.disabled && !__props.pickerProps.readonly && vue.unref(isDateSelectable)(weekDay, __props.month) ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 0,
              ref_for: true,
              ref: (el) => setDayRef(weekDay, el),
              class: vue.normalizeClass(cellClasses(weekDay)),
              role: "button",
              tabindex: __props.day === weekDay.getDate() && __props.month === weekDay.getMonth() ? void 0 : 0,
              onClick: vue.withModifiers(($event) => selectDate(weekDay), ["prevent"]),
              onMouseenter: ($event) => setRangeHoverEndDate(weekDay),
              onFocus: ($event) => setRangeHoverEndDate(weekDay),
              onKeydown: vue.withKeys(vue.withModifiers(($event) => onKeydown($event, weekDay), ["prevent"]), ["enter"])
            }, [
              vue.createElementVNode("span", null, vue.toDisplayString(weekDay.getDate()), 1),
              eventsDateMatch(weekDay).length ? (vue.openBlock(), vue.createElementBlock("div", {
                key: 0,
                class: vue.normalizeClass(vue.unref(tableEventsClasses))
              }, [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(eventsDateMatch(weekDay), (event, index) => {
                  return vue.openBlock(), vue.createElementBlock("div", {
                    key: index,
                    class: vue.normalizeClass(eventClasses(event))
                  }, null, 2);
                }), 128))
              ], 2)) : vue.createCommentVNode("", true)
            ], 42, _hoisted_2$1)) : (vue.openBlock(), vue.createElementBlock("div", {
              key: 1,
              class: vue.normalizeClass(cellClasses(weekDay))
            }, [
              vue.createElementVNode("span", null, vue.toDisplayString(weekDay.getDate()), 1)
...
const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
  ...
  emits: /* @__PURE__ */ vue.mergeModels(["update:model-value", "update:focusedDate", "range-start", "range-end", "week-number-click"], ["update:focusedDate"]),
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emits = __emit;
    const { isDateSelectable } = useDatepickerMixins(props.pickerProps);
    const focusedDateModel = vue.useModel(__props, "focusedDate");
    const selectedBeginDate = vue.ref();
    const selectedEndDate = vue.ref();
    const hoveredEndDate = vue.ref();
    const visibleDayNames = vue.computed(() => {
    ...
    const eventsInThisMonth = vue.computed(() => {
    ...
    const weeksInThisMonth = vue.computed(() => {
      validateFocusedDay();
      ...
      while (weeksInThisMonth2.length < 6) {
        const newWeek = utils.weekBuilder(
          startingDay,
          month,
          year,
    ...
    const hoveredDateRange = vue.computed(() => {
      if (!helpers.isTrueish(props.pickerProps.range) || selectedEndDate.value) return [];
      return ((hoveredEndDate.value || 0) < (selectedBeginDate.value || 0) ? [hoveredEndDate.value, selectedBeginDate.value] : [selectedBeginDate.value, hoveredEndDate.value]).filter(helpers.isDefined);
    });
    ...
    function onSelectedDate(date) {
      ...
      else if (helpers.isTrueish(props.pickerProps.range)) handleSelectRangeDate(date);
      else if (helpers.isTrueish(props.pickerProps.multiple))
    ...
    const tableClasses = defineClasses.defineClasses(["tableClass", "o-dpck__table"]);
    const tableHeadClasses = defineClasses.defineClasses([
      "tableHeadClass",
      "o-dpck__table__head"
    ]);
    const tableCellClasses = defineClasses.defineClasses([
    ...
    const tableHeadCellClasses = defineClasses.defineClasses([
      "tableHeadCellClass",
      "o-dpck__table__head-cell"
    ]);
    const tableBodyClasses = defineClasses.defineClasses([
      "tableBodyClass",
      "o-dpck__table__body"
    ]);
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("section", {
        ...
        vue.createElementVNode("header", {
          class: vue.normalizeClass(vue.unref(tableHeadClasses))
        }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(visibleDayNames.value, (day, index) => {
            return vue.openBlock(), vue.createElementBlock("div", {
              key: index,
              class: vue.normalizeClass([...vue.unref(tableCellClasses), ...vue.unref(tableHeadCellClasses)])
            }, [
              vue.createElementVNode("span", null, vue.toDisplayString(day), 1)
            ], 2);
          }), 128))
        ], 2),
        vue.createElementVNode("div", {
          class: vue.normalizeClass(vue.unref(tableBodyClasses))
        }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(weeksInThisMonth.value, (week, index) => {
...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const monthRefs = vue.ref(/* @__PURE__ */ new Map());
    ...
    const eventsInThisYear = vue.computed(() => {
      if (!props.pickerProps.events) return [];
    ...
    const hoveredDateRange = vue.computed(() => {
      if (!helpers.isTrueish(props.pickerProps.range) || !selectedEndDate.value)
        return [];
      return (hoveredEndDate.value && selectedBeginDate.value && hoveredEndDate.value < selectedBeginDate.value ? [hoveredEndDate.value, selectedBeginDate.value] : [selectedBeginDate.value, hoveredEndDate.value]).filter(helpers.isDefined);
    });
    function eventsDateMatch(day) {
    ...
    const multipleSelectedDates = vue.computed(
      () => helpers.isTrueish(props.pickerProps.multiple) && props.modelValue ? props.modelValue : []
    );
    function handleSelectMultipleDates(date) {
    ...
    function onRangeHoverEndDate(day) {
      if (helpers.isTrueish(props.pickerProps.range)) hoveredEndDate.value = day;
    }
    function dateMatch(dateOne, dateTwo, multiple = false) {
      if (!dateOne || !dateTwo || multiple) return false;
      if (Array.isArray(dateTwo))
    ...
    const monthClasses = defineClasses.defineClasses(["monthClass", "o-dpck__month"]);
    const monthBodyClasses = defineClasses.defineClasses([
      "monthBodyClass",
      "o-dpck__month__body"
    ]);
    const monthTableClasses = defineClasses.defineClasses([
      "monthTableClass",
      "o-dpck__month__table"
    ]);
    const monthCellClasses = defineClasses.defineClasses(
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("section", {
        class: vue.normalizeClass(vue.unref(monthClasses))
      }, [
        vue.createElementVNode("div", {
          class: vue.normalizeClass(vue.unref(monthBodyClasses))
        }, [
          vue.createElementVNode("div", {
            class: vue.normalizeClass(vue.unref(monthTableClasses))
          }, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(monthDates.value, (date, idx) => {
              return vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: idx }, [
                !__props.pickerProps.disabled && !__props.pickerProps.readonly && isDateSelectable(date) ? (vue.openBlock(), vue.createElementBlock("div", {
                  key: 0,
                  ref_for: true,
                  ref: (el) => setMonthRef(date, el),
                  class: vue.normalizeClass(cellClasses(date)),
                  role: "button",
                  tabindex: __props.focusedDate.month === date.getMonth() ? void 0 : 0,
                  onClick: vue.withModifiers(($event) => selectDate(date), ["prevent"]),
                  onMouseenter: ($event) => onRangeHoverEndDate(date),
                  onFocus: ($event) => onRangeHoverEndDate(date),
                  onKeydown: vue.withModifiers(($event) => onKeydown($event, date), ["prevent"])
                }, [
                  vue.createTextVNode(vue.toDisplayString(__props.monthNames[date.getMonth()]) + " ", 1),
                  eventsDateMatch(date).length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
                    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(eventsDateMatch(date), (event, index) => {
                      return vue.openBlock(), vue.createElementBlock("div", {
                        key: index,
                ...
                ], 42, _hoisted_1)) : (vue.openBlock(), vue.createElementBlock("div", {
                  key: 1,
                  class: vue.normalizeClass(cellClasses(date))
                }, vue.toDisplayString(__props.monthNames[date.getMonth()]), 3))
              ], 64);
            }), 128))
          ], 2)
        ], 2)
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels({
    ...
    type: { default: "date" },
    dayNames: { default: () => config.getDefault("datepicker.dayNames") },
    monthNames: { default: () => config.getDefault("datepicker.monthNames") },
    size: { default: () => config.getDefault("datepicker.size") },
    ...
    openOnFocus: { type: Boolean, default: () => config.getDefault("datepicker.openOnFocus", true) },
    closeOnClick: { type: Boolean, default: () => config.getDefault("datepicker.closeOnClick", true) },
    locale: { default: () => config.getDefault("locale") },
    formatter: { type: Function, default: config.getDefault("datepicker.formatter") },
    parser: { type: Function, default: config.getDefault("datepicker.parser") },
    creator: { type: Function, default: config.getDefault("datepicker.creator") },
    selectableDates: { type: [Array, Function], default: void 0 },
    unselectableDates: { type: [Array, Function], default: void 0 },
    unselectableDaysOfWeek: { default: () => config.getDefault("datepicker.unselectableDaysOfWeek") },
    nearbyMonthDays: { type: Boolean, default: () => config.getDefault("datepicker.nearbyMonthDays", true) },
    nearbySelectableMonthDays: { type: Boolean, default: () => config.getDefault("datepicker.nearbySelectableMonthDays", false) },
    showWeekNumber: { type: Boolean, default: () => config.getDefault("datepicker.showWeekNumber", false) },
    weekNumberClickable: { type: Boolean, default: () => config.getDefault("datepicker.weekNumberClickable", false) },
    firstDayOfWeek: { default: () => config.getDefault("datepicker.firstDayOfWeek", 0) },
    rulesForFirstWeek: { default: 4 },
    yearsRange: { default: () => config.getDefault("datepicker.yearsRange", [-100, 10]) },
    trapFocus: { type: Boolean, default: () => config.getDefault("datepicker.trapFocus", true) },
    position: { default: void 0 },
    mobileModal: { type: Boolean, default: () => config.getDefault("datepicker.mobileModal", true) },
    mobileNative: { type: Boolean, default: () => config.getDefault("datepicker.mobileNative", false) },
    iconPack: { default: () => config.getDefault("datepicker.iconPack") },
    icon: { default: () => config.getDefault("datepicker.icon") },
    iconRight: { default: () => config.getDefault("datepicker.iconRight") },
    iconRightClickable: { type: Boolean, default: false },
    iconPrev: { default: () => config.getDefault("datepicker.iconPrev", "chevron-left") },
    iconNext: { default: () => config.getDefault("datepicker.iconNext", "chevron-right") },
    mobileBreakpoint: { default: () => config.getDefault("datepicker.mobileBreakpoint") },
    teleport: { type: [Boolean, String, Object], default: () => config.getDefault("datepicker.teleport", false) },
    ...
    ariaNextLabel: { default: () => config.getDefault("datepicker.ariaNextLabel", "Next Page") },
    ariaPreviousLabel: { default: () => config.getDefault("datepicker.ariaNextLabel", "Previous Page") },
    rootClass: {},
    sizeClass: {},
    boxClass: {},
    headerClass: {},
    ...
    dropdownClass: {},
    inputClass: {},
    inputClasses: { default: () => config.getDefault("datepicker.inputClasses") },
    dropdownClasses: { default: () => config.getDefault("datepicker.dropdownClasses") },
    selectClasses: { default: () => config.getDefault("datepicker.selectClasses") }
  }, {
    "modelValue": { default: void 0 },
    "modelModifiers": {},
    "active": { type: Boolean, ...{ default: false } },
  ...
  emits: /* @__PURE__ */ vue.mergeModels(["update:model-value", "update:active", "range-start", "range-end", "change-month", "change-year", "focus", "blur", "invalid", "icon-click", "icon-right-click"], ["update:modelValue", "update:active"]),
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const computedMonthNames = vue.computed(
      () => Array.isArray(props.monthNames) ? props.monthNames : utils.getMonthNames(props.locale)
    );
    const listOfMonths = vue.computed(() => {
      let minMonth = 0;
      let maxMonth = 12;
    ...
    const computedDayNames = vue.computed(
      () => Array.isArray(props.dayNames) ? props.dayNames : utils.getWeekdayNames(props.locale)
    );
    const listOfYears = vue.computed(() => {
    ...
    function formatNative(value) {
      ...
      if (isTypeMonth.value) {
        ...
        return year + "-" + helpers.pad(month);
      } else {
        const year = date.getFullYear();
        const month = date.getMonth() + 1;
        const day = date.getDate();
        return year + "-" + helpers.pad(month) + "-" + helpers.pad(day);
      }
    }
    function parse(value, isNative) {
      if (isNative) return parseNative(value);
      const date = dateParser(value);
      const isValid = helpers.isDate(date) || Array.isArray(date) && date.length === 2 && helpers.isDate(date[0]) && helpers.isDate(date[1]);
    ...
    const rootClasses = defineClasses.defineClasses(
      ...
      ["expandedClass", "o-dpck--expanded", null, vue.computed(() => props.expanded)]
    );
    const headerClasses = defineClasses.defineClasses(["headerClass", "o-dpck__header"]);
    const headerButtonsClasses = defineClasses.defineClasses(
    ...
    const prevButtonClasses = defineClasses.defineClasses([
      "prevButtonClass",
      "o-dpck__header__previous"
    ]);
    const nextButtonClasses = defineClasses.defineClasses([
      "nextButtonClass",
      "o-dpck__header__next"
    ]);
    const listsClasses = defineClasses.defineClasses(["listsClass", "o-dpck__header__list"]);
    const footerClasses = defineClasses.defineClasses(["footerClass", "o-dpck__footer"]);
    const pickerDropdownClasses = defineClasses.defineClasses([
      "dropdownClass",
      "o-tpck__dropdown"
    ]);
    const boxClasses = defineClasses.defineClasses(["boxClass", "o-dpck__box"]);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(utils._sfc_main, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("header", {
            class: vue.normalizeClass(vue.unref(headerClasses))
          }, [
            vue.renderSlot(_ctx.$slots, "header", {}, () => [
              vue.createElementVNode("div", {
                class: vue.normalizeClass(vue.unref(headerButtonsClasses))
              }, [
                !_ctx.disabled ? (vue.openBlock(), vue.createBlock(Button_vue_vue_type_script_setup_true_lang._sfc_main, {
                  key: 0,
                  class: vue.normalizeClass(vue.unref(prevButtonClasses)),
                  ...
                  onKeydown: [
                    vue.withKeys(vue.withModifiers(prev, ["prevent"]), ["enter"]),
                    vue.withKeys(vue.withModifiers(prev, ["prevent"]), ["space"])
                  ]
                }, null, 8, ["class", "disabled", "aria-label", "icon-pack", "icon-left", "onKeydown"])) : vue.createCommentVNode("", true),
                !_ctx.disabled ? (vue.openBlock(), vue.createBlock(Button_vue_vue_type_script_setup_true_lang._sfc_main, {
                  key: 1,
                  class: vue.normalizeClass(vue.unref(nextButtonClasses)),
                  ...
                  onKeydown: [
                    vue.withKeys(vue.withModifiers(next, ["prevent"]), ["enter"]),
                    vue.withKeys(vue.withModifiers(next, ["prevent"]), ["space"])
                  ]
                }, null, 8, ["class", "disabled", "aria-label", "icon-pack", "icon-left", "onKeydown"])) : vue.createCommentVNode("", true),
                vue.createElementVNode("div", {
                  class: vue.normalizeClass(vue.unref(listsClasses))
                }, [
                  !isTypeMonth.value ? (vue.openBlock(), vue.createBlock(Select_vue_vue_type_script_setup_true_lang._sfc_main, vue.mergeProps({ key: 0 }, _ctx.selectClasses, {
                    ...
                    onKeydown: [
                      vue.withKeys(vue.withModifiers(prev, ["stop", "prevent"]), ["left"]),
                      vue.withKeys(vue.withModifiers(next, ["stop", "prevent"]), ["right"])
                    ]
                  }), null, 16, ["modelValue", "disabled", "size", "options", "onKeydown"])) : vue.createCommentVNode("", true),
                  vue.createVNode(Select_vue_vue_type_script_setup_true_lang._sfc_main, vue.mergeProps(_ctx.selectClasses, {
                    ...
                    onKeydown: [
                      vue.withKeys(vue.withModifiers(prev, ["stop", "prevent"]), ["left"]),
                      vue.withKeys(vue.withModifiers(next, ["stop", "prevent"]), ["right"]),
                      _cache[2] || (_cache[2] = vue.withKeys(vue.withModifiers(($event) => focusedDateData.value.year += 1, ["stop", "prevent"]), ["up"])),
                      _cache[3] || (_cache[3] = vue.withKeys(vue.withModifiers(($event) => focusedDateData.value.year -= 1, ["stop", "prevent"]), ["down"]))
                    ]
          ...
          vue.renderSlot(_ctx.$slots, "body", {}, () => [
            isTypeMonth.value ? (vue.openBlock(), vue.createBlock(_sfc_main$1, {
              key: 0,
            ...
            }, null, 8, ["modelValue", "focused-date", "month-names"])) : (vue.openBlock(), vue.createBlock(_sfc_main$2, {
              key: 1,
              modelValue: vmodel.value,
...
//# sourceMappingURL=Datepicker.vue_vue_type_script_setup_true_lang-DRSIxr_5.cjs.map
