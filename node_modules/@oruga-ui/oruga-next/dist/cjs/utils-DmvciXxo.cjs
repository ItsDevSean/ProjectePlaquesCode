...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ariaRole = vue.computed(
      () => !helpers.isTrueish(props.pickerProps.inline) ? "dialog" : void 0
    );
    const triggers = vue.computed(
      () => helpers.isTrueish(props.pickerProps.openOnFocus) ? ["click"] : []
    );
    if (ssr.isClient) useEventListener.useEventListener(document, "keyup", onKeyPress);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        ]), 1040, ["active", "position", "disabled", "inline", "mobile-modal", "mobile-breakpoint", "trap-focus", "aria-role", "aria-modal", "teleport", "triggers"])) : vue.renderSlot(_ctx.$slots, "trigger", { key: 1 }, () => [
...
//# sourceMappingURL=utils-DmvciXxo.cjs.map
