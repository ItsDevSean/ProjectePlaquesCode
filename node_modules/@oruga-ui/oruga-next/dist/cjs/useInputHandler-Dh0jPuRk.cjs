...
function useInputHandler(inputRef, emits, props) {
  ...
  if (!ssr.isSSR) {
    ...
    const onAttributeChange = () => {
      vue.triggerRef(forceValidationUpdate);
    };
    ...
    vue.watch(
      ...
      (newData, oldData) => {
        ...
        const needWatcher = helpers.isDefined(el) && useValidation && // For inputs known to be invalid, changes in constraint validation properties
        ...
        if (needWatcher && helpers.isDefined(el) && el !== oldEl) {
...
//# sourceMappingURL=useInputHandler-Dh0jPuRk.cjs.map
