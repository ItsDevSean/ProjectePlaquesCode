...
const Autocomplete_vue_vue_type_script_setup_true_lang = require("./Autocomplete.vue_vue_type_script_setup_true_lang-B3AiX-cf.cjs");
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels({
    ...
    confirmKeys: { default: () => config.getDefault("taginput.confirmKeys", [",", "Tab", "Enter"]) },
    separators: { default: () => config.getDefault("taginput.separators", [","]) },
    ...
    removeOnKeys: { default: () => config.getDefault("taginput.removeOnKeys", ["Backspace"]) },
    ...
    ariaCloseLabel: { default: () => config.getDefault("taginput.ariaCloseLabel") },
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const selectedOptions = vue.computed(() => {
      ...
      return selectedItems.value.map((value) => {
        const option = useOptions.findOption(normalizedOptions, value);
          ...
          vue.renderSlot(_ctx.$slots, "selected", {
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(selectedOptions.value, (option, index2) => {
              return vue.openBlock(), vue.createElementBlock("span", {
                ...
                _ctx.closable ? (vue.openBlock(), vue.createBlock(Icon_vue_vue_type_script_setup_true_lang._sfc_main, {
                  key: 0,
