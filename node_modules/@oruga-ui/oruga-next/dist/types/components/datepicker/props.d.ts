...
type DatepickerType<IsRange, IsMultiple> = IsRange extends true ? [Date, Date] | [] : IsMultiple extends true ? Date[] : Date;
export type DatepickerProps<IsRange extends boolean = false, IsMultiple extends boolean = false> = {
    ...
    formatter?: (date: DatepickerProps<IsRange, IsMultiple>["modelValue"]) => string;
    /** Custom function to parse a string into a date */
    parser?: (date: string) => DatepickerProps<IsRange, IsMultiple>["modelValue"];
    ...
    customValidity?: string | ((currentValue: DatepickerType<IsRange, IsMultiple> | null | undefined, state: ValidityState) => string);
