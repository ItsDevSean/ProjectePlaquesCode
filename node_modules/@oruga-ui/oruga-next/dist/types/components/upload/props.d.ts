...
export type UploadProps<T extends object | typeof File, IsMultiple extends boolean> = {
    ...
    customValidity?: string | ((currentValue: UploadType<T, IsMultiple> | null | undefined, state: ValidityState) => string);
} & UploadClasses;
