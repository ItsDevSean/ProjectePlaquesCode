...
export type InputType<IsNumber extends boolean> = IsNumber extends true ? number : string;
export type InputProps<IsNumber extends boolean> = {
    ...
    customValidity?: string | ((currentValue: InputType<IsNumber> | null | undefined, state: ValidityState) => string);
} & InputClasses;
