...
export declare function useTimepickerMixins(props: TimepickerProps): {
    dtf: import('vue').ComputedRef<Intl.DateTimeFormat>;
    timeCreator: () => Date;
    timeFormatter: (time: typeof props.modelValue) => string;
    timeParser: (time: string) => typeof props.modelValue;
    ...
    secondLiteral: import('vue').ComputedRef<string | undefined>;
};
