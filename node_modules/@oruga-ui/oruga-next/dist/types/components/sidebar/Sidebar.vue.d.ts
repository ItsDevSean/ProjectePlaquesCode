...
declare const _default: <C extends Component>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_expose?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
    props: __VLS_PrettifyLocal<Pick<Partial<{}> & Omit<{
    ...
    } & import('vue').VNodeProps & import('vue').AllowedComponentProps & import('vue').ComponentCustomProps, never>, "onClose" | "onUpdate:active"> & Partial<{}> & ({
        active?: boolean;
    } & {
        override?: boolean;
        active?: boolean;
        ...
        fullheightClass: import('../..').ComponentClass;
        fullwidthClass: import('../..').ComponentClass;
        inlineClass: import('../..').ComponentClass;
        reduceClass: import('../..').ComponentClass;
        expandOnHoverClass: import('../..').ComponentClass;
        mobileClass: import('../..').ComponentClass;
        scrollClipClass: import('../..').ComponentClass;
        noScrollClass: import('../..').ComponentClass;
        hiddenClass: import('../..').ComponentClass;
        visibleClass: import('../..').ComponentClass;
