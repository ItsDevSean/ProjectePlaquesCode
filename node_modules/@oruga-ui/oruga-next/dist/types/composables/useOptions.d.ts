...
type NormalizedOptions<V, O extends OptionsPropWithGroups<V> = OptionsPropWithGroups<V>> = O extends OptionsProp<V> ? OptionsItem<V>[] : O extends OptionsGroupPropItem<V> ? OptionsGroupItem<V>[] : never[];
/**
 ...
 */
export declare function normalizeOptions<V, O extends OptionsPropWithGroups<V> = OptionsPropWithGroups<V>, R extends NormalizedOptions<V, O> = NormalizedOptions<V, O>>(options: O | undefined, uuid: () => string): R;
/**
 ...
 */
export declare function isGroupOption(option: OptionsItem | OptionsGroupItem): option is OptionsGroupItem;
 ...
 */
export declare function filterOptionsItems<V, O extends OptionsItem<V>[] | OptionsGroupItem<V>[]>(options: MaybeRefOrGetter<O>, value: MaybeRefOrGetter<string>, customFilter?: (option: V, value: string) => boolean): O;
/**
 ...
 */
export declare function firstValidOption<V>(options: MaybeRefOrGetter<OptionsItem<V>[]> | MaybeRefOrGetter<OptionsGroupItem<V>[]>): OptionsItem<V> | undefined;
export declare function isOptionValid(option: MaybeRefOrGetter<OptionsItem>): boolean;
export {};
