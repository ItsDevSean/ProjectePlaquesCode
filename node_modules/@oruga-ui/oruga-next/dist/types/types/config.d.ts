import { ValidatableFormElement } from '../composables';
import { IconConfig } from '../utils/icons';
import { DynamicComponent } from './utils';
/** export option types */
export type { OptionsItem, OptionsPropItem, OptionsGroupItem, OptionsGroupPropItem, OptionsProp, OptionsGroupProp, OptionsPropWithGroups, } from '../composables';
export type ComponentProps = Record<string, any>;
export type ClassFunction = (suffix: string, props: ComponentProps) => string | undefined;
...
export type GlobalConfig = Partial<{
    ...
    invalidHandler: (validatable: ValidatableFormElement, fieldElement: Element) => void;
