...
export declare const getOption: <K extends string = string>(path: K, defaultValue?: DeepType<OrugaOptions, K>) => DeepType<OrugaOptions, K>;
...
export declare const ConfigProgrammatic: {
    getOption: <K extends string = string>(path: K, defaultValue?: DeepType<OrugaOptions, K>) => DeepType<OrugaOptions, K>;
