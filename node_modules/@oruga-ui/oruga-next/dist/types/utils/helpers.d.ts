 ...
 */
export declare function sortBy<T>(array: T[], key: string, fn?: (a: T, b: T, asc: boolean) => number, isAsc?: boolean): T[];
/**
 ...
 */
export declare function getValueByPath<O, K extends keyof O | string>(obj: O, path: K, defaultValue?: DeepType<O, K>): DeepType<O, K>;
/**
