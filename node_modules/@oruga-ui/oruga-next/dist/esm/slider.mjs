...
import { defineComponent, ref, computed, openBlock, createElementBlock, normalizeClass, normalizeStyle, createVNode, withCtx, createElementVNode, mergeProps, withKeys, withModifiers, toDisplayString, createCommentVNode, unref, renderSlot, createTextVNode, useTemplateRef, watch, Fragment, renderList, createBlock } from "vue";
import { _ as _sfc_main$3 } from "./Tooltip.vue_vue_type_script_setup_true_lang-B6aSliML.mjs";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          unref(isTrueish)(props.range) ? (openBlock(), createBlock(_sfc_main$2, {
            key: 1,
