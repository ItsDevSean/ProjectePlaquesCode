                    ...
                    <div class="ml-10 flex items-center space-x-8">
                        ...
                        @if (Route::has('login'))
                            ...
                            <a href="{{ url('/proyectos') }}"
                                ...
                                class="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-5 py-2 rounded-md text-sm font-medium transition duration-300 shadow-md">
                                !EMPIEZA YA!
                            </a>
                            @else
                            <a href="{{ route('login') }}"
