...
<body>
    <x-app-layout>
        ...
        <!-- Barra de progres -->
<div class="progress-bar-container mt-4 px-4 bg-white rounded-xl pr-6 pl-11 bg-opacity-80" x-data="{
                        ...
                        <div class="relative group transform -translate-x-1/2">
                            ...
                            <div class="absolute top-full mt-3 left-1/2 transform -translate-x-1/2 text-center">
                                <span class="whitespace-nowrap font-medium px-3 py-1.5 rounded-lg"
                                      :class="{
                                          'text-sm font-semibold text-gray-800 dark:text-white': step.id === currentStep,
